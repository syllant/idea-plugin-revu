...
public class RevuProjectSettingsForm implements ProjectComponent, Configurable
{
  ...
  private void $$$setupUI$$$()
  {
    ...
    contentPane.add(splitPane1, "form");
    ...
    scrollPane1.setViewportView(liReviews);
    panel1.add(reviewToolBar, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
      GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
      GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
    splitPane1.setRightComponent(reviewForm.$$$getRootComponent$$$());
    lbMessage = new JLabel();
    lbMessage.setHorizontalAlignment(0);
    lbMessage.setHorizontalTextPosition(11);
