  ...
  implements DataProvider
{
  ...
  public ReviewItemsTable(@NotNull Project project, @NotNull List<ReviewItem> items, @Nullable Review review)
  {
    super(new ReviewItemsTableModel(project, items, review));
  ...
  public void filter(@NotNull String filterValue)
  {
    ...
    ((ReviewItemsTableModel) getModel()).filter(filterValue);
  }
  ...
  public TableCellRenderer getCellRenderer(int row, int column)
  {
    ...
    return new TableCellRenderer()
    {
      public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        int row, int column)
      {
        Component result = ReviewItemsTable.super.getCellRenderer(row, column).getTableCellRendererComponent(table,
  ...
  public JComponent buildFilterComponent()
  {
    return new FilterComponent("revuTableFilter", 5)
    {
      public void filter()
      {
        ReviewItemsTable.this.filter(getFilter().toLowerCase());
      }
    };
  }
